                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <td>
                                        <input form="form-add-account" class="form-control form-table" id="password" name="password" type="password" placeholder="รหัสผ่าน" value=""  required>
                                    </td>
                                    <td>
                                        <input form="form-add-account" class="form-control form-table" id="email" name="email" type="email" placeholder="อีเมล" value="" required>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button form="form-add-account" class="btn btn-primary waves-effect waves-light" type="submit"><i class="fa fa-plus right"></i></button>
                                    </td>
                                </form>
                            </tr>
                            <!--/Add row-->
